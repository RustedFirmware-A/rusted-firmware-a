    ...
    ($platform:ty) => {
        ...
        mod debug_asm {
            ...
            core::arch::global_asm!(
                ...
                plat_crash_console_init = sym <<PlatformImpl as $crate::platform::Platform>::CrashConsoleImpl as $crate::crash_console::CrashConsole>::crash_console_init,
                plat_crash_console_putc = sym <<PlatformImpl as $crate::platform::Platform>::CrashConsoleImpl as $crate::crash_console::CrashConsole>::crash_console_putc,
                plat_crash_console_flush = sym <<PlatformImpl as $crate::platform::Platform>::CrashConsoleImpl as $crate::crash_console::CrashConsole>::crash_console_flush,
